<div class="col-lg-8">
    ...
    <table width="100%" class="table table-striped table-bordered table-hover" id="chatRoom">
        <thead>
            <tr>
                <th>Goups de discusion</th>
                <th>Date de creation</th>
                <th><span class="glyphicon glyphicon-lock"></span> Mot de pass || <span
                        class="glyphicon glyphicon-user"></span> Membre</th>
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            <tr>
                ...
                <td><button value="<?php echo $row['chatroomid']; ?>" class="btn btn-info join_chat"><span
                            class="glyphicon glyphicon-comment"></span> Joindre</button> &nbsp;
                    <?php
					if (!empty($row['chat_password'])){
