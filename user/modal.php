        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <center><strong><span style="font-size: 15px;">vous etes: <?php echo $user; ?></span></strong>
                    </center>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <center>
                    <h4 class="modal-title" id="myModalLabel">Telecharger une photo...</h4>
                </center>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form method="POST" action="update_account.php">
                        ...
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Retaper le mot de passe:</span>
